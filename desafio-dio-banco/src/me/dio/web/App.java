...
import me.dio.web.controles.Banco;
...
public class App {
    ...
    private static void showMenu() {
        ...
        System.out.println("9 - listas todas as contas e saldos");

        System.out.println("10 - sacar de uma conta Simples");
        System.out.println("11 - depositar ee uma conta Simples");
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (opcao != 0) {
            switch (opcao) {
                ...
                case 5:
                    System.out.println("Cliente PF[1] ou PJ[2]");
                    int tipoPJouPF = scan.nextInt();
                    scan.nextLine();
                    if(tipoPJouPF == 1 ){
                ...
                case 6:
                    ...
                    if(tipoPJouPF == 1 ){
                        ...
                        if (clientePJ != null) {
                            ...
                            contaEspecial = new ContaCorrenteEspecial(numero, agencia, clientePJ, 0.0, limite);
